...
const { verifyAdmin, verificationCheck, addBus, getRouteForBus, getStationNameFromID, getStationPositionFromID, getConnectedBuses, markNextStationCrossed, getETA } = require('./controllers/admin');
...
app.post('/stationPosition', getStationPositionFromID);
app.get('/getConnectedBuses', getConnectedBuses);
app.post('/markNextStationCrossed', markNextStationCrossed);
app.get('/getETA', getETA);
