...
const main = async () => {
    ...
    // const encodedName = encodeURIComponent(`E.S.I. Hospital, Pune`);
    ...
    // const station = await Station.updateOne({ name: 'E.S.I. Hospital' }, { $set: { latitude: position.lat, longitude: position.lng } });
    // console.log(station);
